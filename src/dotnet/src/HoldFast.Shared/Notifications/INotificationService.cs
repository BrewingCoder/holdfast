...
public interface INotificationService
{
    ...
    /// Ported from Go's alerts/v2/destinations/slack notification path.
    /// </summary>
    /// <param name="accessToken">OAuth Bearer token for the Slack workspace.</param>
    /// <param name="channelId">Slack channel ID (not channel name) to post into.</param>
    /// <param name="message">Pre-built Slack message payload (blocks + attachments).</param>
    ...
    /// </summary>
    /// <param name="webhookUrl">Discord incoming webhook URL.</param>
    /// <param name="message">Pre-built Discord message payload (content + embeds).</param>
    /// <param name="ct">Cancellation token.</param>
    ...
    /// <param name="message">Pre-built Teams Adaptive Card message payload.</param>
    /// <param name="ct">Cancellation token.</param>
    ...
    /// Useful for custom integrations (PagerDuty, OpsGenie, etc.).
    /// </summary>
    /// <param name="url">Target webhook URL.</param>
    /// <param name="payload">Object to serialize as JSON in the POST body.</param>
    /// <param name="ct">Cancellation token.</param>
