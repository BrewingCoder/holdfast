...
const FAQ = [
	...
	{
		question: 'Should I use your Cloud product or self-host HoldFast?',
		answer: 'It is easier to get started with HoldFast Cloud, and we have a generous monthly free tier. If you have complex data sovereignty requirements, you will likely need a self-hosted plan.',
	},
	{
		question: 'Can I migrate between Cloud and self-hosted HoldFast?',
				...
				<Button
					...
					onClick={() => {
						...
						if (free) {
							...
							window.open(
								`${window.location.origin}/sign_up?ref=hobby`,
							)
						} else {
		...
		>
			...
			>
				...
				<Box display="flex" alignItems="center" gap="8">
					...
					<TextLink
						color="none"
						href="/docs/general/product-features/session-replay/filtering-sessions#set-up-ingestion-filters"
					>
						Learn more
					</TextLink>
				</Box>
