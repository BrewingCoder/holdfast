...
const getLearnMoreLink = ({ errorObject }: Props) => {
	...
	if (!session) {
		return '/docs/getting-started/frontend-backend-mapping'
	}
	...
	switch (excludedReason) {
		case SessionExcludedReason.IgnoredUser: {
			return '/docs/general/product-features/session-replay/filtering-sessions#filter-sessions-by-user-identifier'
		}
		default:
			return null
	}
