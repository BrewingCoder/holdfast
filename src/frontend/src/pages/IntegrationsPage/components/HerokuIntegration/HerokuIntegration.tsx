...
import { Form } from '@holdfast-io/ui/components'
		...
		return (
			<>
				<p className={styles.modalSubTitle}>
					Disconnecting your Heroku workspace from HoldFast will
	...
	return (
		<>
			<p className={styles.modalSubTitle}>
				...
				shipping your logs to HoldFast.{' '}
				<a
				...
				>
					Add the drain token to HoldFast.
				</a>
			</p>
