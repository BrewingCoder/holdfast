	...
	return (
		<>
			<p className={styles.modalSubTitle}>
				Connect HoldFast with Vercel to configure environment variables
...
const VercelIntegrationDisconnect: React.FC<IntegrationConfigProps> = ({
	...
	return (
		<>
			<p className={styles.modalSubTitle}>
				Disconnecting Vercel from HoldFast will remove the environment
	...
	return (
		<div>
			<p className={clsx(styles.modalSubTitle)}>
				Select Vercel projects to link to your HoldFast projects.
			</p>
			<div className="my-6">
				<Card noPadding>
					<Table
