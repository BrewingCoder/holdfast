...
export const SLACK_INTEGRATION: Integration = {
	...
	description:
		'Bring your HoldFast comments and alerts to Slack as messages.',
	icon: SlackLogo,
...
export const MICROSOFT_TEAMS_INTEGRATION: Integration = {
	...
	description: 'Receive HoldFast alerts via Microsoft Teams messages.',
...
export const LINEAR_INTEGRATION: IssueTrackerIntegration = {
	...
	description: 'Bring your HoldFast comments to Linear as issues.',
	icon: LinearLogo,
...
export const JIRA_INTEGRATION: IssueTrackerIntegration = {
	...
	description: 'Bring your HoldFast comments to Jira as issues.',
	icon: JiraLogo,
...
export const GITLAB_INTEGRATION: IssueTrackerIntegration = {
	...
	description: 'Bring your HoldFast comments to GitLab as issues.',
	icon: GitlabLogo,
...
export const ZAPIER_INTEGRATION: Integration = {
	...
	description: 'Use HoldFast alerts to trigger a Zap.',
	icon: ZapierLogo,
...
export const DISCORD_INTEGRATION: Integration = {
	...
	description: 'Bring your HoldFast alerts to Discord as messages.',
	icon: DiscordLogo,
...
export const CLICKUP_INTEGRATION: IssueTrackerIntegration = {
	...
	description: 'Create ClickUp tasks from your HoldFast comments.',
...
export const HEIGHT_INTEGRATION: IssueTrackerIntegration = {
	...
	description: 'Create Height tasks from your HoldFast comments.',
