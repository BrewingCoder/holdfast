...
type AllWorkspaceSettings struct {
	...
	AIInsights     bool `gorm:"default:true"`
	AIQueryBuilder bool `gorm:"default:true"`
	...
	EnableIngestSampling     bool `gorm:"default:true"`
	EnableProjectLevelAccess bool `gorm:"default:true"`
	EnableSessionExport      bool `gorm:"default:true"`
	EnableSSO                bool `gorm:"default:true"`
	...
	EnableJiraIntegration  bool `gorm:"default:true"`
	EnableTeamsIntegration bool `gorm:"default:true"`

	EnableLogTraceIngestion bool `gorm:"default:true"`
}
