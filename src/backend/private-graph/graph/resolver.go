...
// Self-hosted: billing details updates are no-ops
func (r *Resolver) updateAWSMPBillingDetails(ctx context.Context, workspaceID int, customer interface{}) error {
	return nil
}
...
func (r *Resolver) updateBillingDetails(ctx context.Context, workspaceID int, details interface{}) error {
	return nil
}
...
// Self-hosted: Stripe webhook is a no-op
...
// Self-hosted: AWS Marketplace callback is a no-op
