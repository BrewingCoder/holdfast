...
import (
	...
	generated1 "github.com/BrewingCoder/holdfast/src/backend/public-graph/graph/generated"
...
func (r *mutationResolver) IdentifySession(ctx context.Context, sessionSecureID string, userIdentifier string, userObject any) (string, error) {
	err := r.ProducerQueue.Submit(ctx, sessionSecureID, &kafkaqueue.Message{
...
func (r *mutationResolver) AddSessionProperties(ctx context.Context, sessionSecureID string, propertiesObject any) (string, error) {
	err := r.ProducerQueue.Submit(ctx, sessionSecureID, &kafkaqueue.Message{
...
func (r *mutationResolver) PushPayloadCompressed(ctx context.Context, sessionSecureID string, payloadID int, data string) (any, error) {
	payloadIDInt64 := int64(payloadID)
...
func (r *mutationResolver) PushSessionEvents(ctx context.Context, sessionSecureID string, payloadID int64, data string) (any, error) {
...
func (r *mutationResolver) PushBackendPayload(ctx context.Context, projectID *string, errors []*customModels.BackendErrorObjectInput) (any, error) {
...
func (r *mutationResolver) MarkBackendSetup(ctx context.Context, projectID *string, sessionSecureID *string, typeArg *string) (any, error) {
	return nil, nil
}
...
func (r *queryResolver) Ignore(ctx context.Context, id int) (any, error) {
	return nil, nil
}
