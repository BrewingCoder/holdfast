	...
	for name, tc := range tests {
		util.RunTestWithDBWipeWithName(t, resolver.DB, name, func(t *testing.T) {
			...
			for _, errorObj := range tc.errorsToInsert {
				...
				errorGroup, _, err := resolver.HandleErrorAndGroup(context.TODO(), &errorObj, []time.Time{errorObj.Timestamp}, structuredStackTrace, 1, &workspace)
				if err != nil {
...
func TestMatchErrorsWithSameTracesDifferentBodies(t *testing.T) {
	stacktrace := `[{"fileName":"/Users/ericthomas/code/highlight/backend/private-graph/graph/schema.resolvers.go","lineNumber":6517,"functionName":"Admin","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/code/highlight/backend/private-graph/graph/resolver.go","lineNumber":216,"functionName":"getCurrentAdmin","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/code/highlight/backend/private-graph/graph/schema.resolvers.go","lineNumber":6609,"functionName":"AdminRoleByProject","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/code/highlight/backend/private-graph/graph/generated/generated.go","lineNumber":44838,"functionName":"func2","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/go-workspace/pkg/mod/github.com/99designs/gqlgen@v0.17.24/graphql/executor/extensions.go","lineNumber":72,"functionName":"func4","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/go-workspace/pkg/mod/github.com/99designs/gqlgen@v0.17.24/graphql/executor/extensions.go","lineNumber":110,"functionName":"1","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/code/highlight/sdk/highlight-go/tracer.go","lineNumber":59,"functionName":"InterceptField","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/go-workspace/pkg/mod/github.com/99designs/gqlgen@v0.17.24/graphql/executor/extensions.go","lineNumber":109,"functionName":"func8","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/go-workspace/pkg/mod/github.com/99designs/gqlgen@v0.17.24/graphql/executor/extensions.go","lineNumber":110,"functionName":"1","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/code/highlight/backend/util/tracer.go","lineNumber":45,"functionName":"InterceptField","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/go-workspace/pkg/mod/github.com/99designs/gqlgen@v0.17.24/graphql/executor/extensions.go","lineNumber":109,"functionName":"func8","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/code/highlight/backend/private-graph/graph/generated/generated.go","lineNumber":44836,"functionName":"_Query_admin_role_by_project","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/code/highlight/backend/private-graph/graph/generated/generated.go","lineNumber":66748,"functionName":"func316","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/go-workspace/pkg/mod/github.com/99designs/gqlgen@v0.17.24/graphql/executor/extensions.go","lineNumber":69,"functionName":"func3","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null},{"fileName":"/Users/ericthomas/code/highlight/backend/private-graph/graph/generated/generated.go","lineNumber":66753,"functionName":"func317","columnNumber":null,"error":"github.com/BrewingCoder/holdfast/src/backend/private-graph/graph.(*queryResolver).Admin","sourceMappingErrorMetadata":null,"lineContent":null,"linesBefore":null,"linesAfter":null}]`
	...
	util.RunTestWithDBWipe(t, resolver.DB, func(t *testing.T) {
		...
		errorGroup1, _, err := resolver.HandleErrorAndGroup(context.TODO(), &errorObject, []time.Time{errorObject.Timestamp}, structuredStackTrace, project.ID, nil)
		assert.NoError(t, err)
		...
		errorGroup2, _, err := resolver.HandleErrorAndGroup(context.TODO(), &errorObject, []time.Time{errorObject.Timestamp}, structuredStackTrace, project.ID, nil)
		assert.NoError(t, err)
...
func TestUpdatingErrorState(t *testing.T) {
	...
	util.RunTestWithDBWipe(t, resolver.DB, func(t *testing.T) {
		...
		errorGroup, _, err := resolver.HandleErrorAndGroup(ctx, &errorObject1, []time.Time{errorObject1.Timestamp}, structuredStackTrace, project.ID, nil)
		assert.NoError(t, err)
		...
		errorGroup, _, err = resolver.HandleErrorAndGroup(ctx, &errorObject2, []time.Time{errorObject2.Timestamp}, structuredStackTrace, project.ID, nil)
		assert.NoError(t, err)
		assert.Equal(t, errorGroup.State, privateModel.ErrorStateOpen)
		...
		errorGroup, _, err = resolver.HandleErrorAndGroup(ctx, &errorObject3, []time.Time{errorObject3.Timestamp}, structuredStackTrace, project.ID, nil)
		assert.NoError(t, err)
