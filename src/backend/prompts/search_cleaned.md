...
```
tag="/\w \w/"
visited-url="/https://app.holdfast.io/\d/.+/"
```
...
All of our search pages allow you to save a search and reuse it later. We call these **segments**. Create segments for common sets of filters you want to use across HoldFast.
