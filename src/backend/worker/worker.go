...
import (
	...
	journey_handlers "github.com/BrewingCoder/holdfast/src/backend/lambda-functions/journeys/handlers"
	"github.com/BrewingCoder/holdfast/src/backend/model"
	"github.com/BrewingCoder/holdfast/src/backend/payload"
	mgraph "github.com/BrewingCoder/holdfast/src/backend/private-graph/graph"
...
func (w *Worker) ReportStripeUsage(ctx context.Context) {
	// Self-hosted: no Stripe usage reporting
}
