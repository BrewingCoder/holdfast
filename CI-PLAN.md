...
| `@holdfast-io/sourcemap-uploader` | `sourcemap-uploader/` | CLI tool for uploading sourcemaps |
...
| `@holdfast-io/frontend` | `frontend/` | React dashboard app |
...
|----------------|-------|---------|
| `holdfast-backend` | Go backend — GraphQL APIs, workers, storage, alerts | `/backend/` |
| `holdfast-frontend` | React dashboard application | `/frontend/` |
...
| `holdfast-infra` | Docker, deployment configs, collector | `/docker/`, `/deploy/`, `/infra/` |
