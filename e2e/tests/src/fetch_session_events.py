...
OAUTH_URL = os.environ.get("HIGHLIGHT_PRIVATE_GRAPH_URI", "http://localhost:8082/private") + "/oauth"
API_URL = os.environ.get("HIGHLIGHT_PRIVATE_GRAPH_URI", "http://localhost:8082/private")
