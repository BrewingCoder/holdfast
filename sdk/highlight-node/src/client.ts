...
const OTLP_HTTP = process.env.HIGHLIGHT_OTLP_ENDPOINT || 'http://localhost:4318'
...
export class Highlight {
	...
	constructor(options: NodeOptions) {
		...
		if (!this._projectID) {
			console.warn(
				'HoldFast project id was not provided. Data will not be recorded.',
			)
		}
		...
		attributes['telemetry.distro.name'] = '@holdfast-io/node'
