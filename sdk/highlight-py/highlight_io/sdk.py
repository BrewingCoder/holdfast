...
class H(object):
    ...
    OTLP_HTTP = os.environ.get("HIGHLIGHT_OTLP_ENDPOINT", "http://localhost:4317")
    _instance: "H" = None
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param project_id: a string that corresponds to the verbose id of your project from the setup page in the dashboard
