...
import { Box } from '@holdfast-io/ui/components'
...
const FEATURE_DESCRIPTIONS = {
	...
	'Jira Integration':
		'create Jira issues from your HoldFast errors and sessions.',
	'Teams Integration':
		'receive HoldFast alerts via Microsoft Teams messages.',
	'Single Sign-On (SSO)':
