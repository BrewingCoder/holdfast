...
import { Box, ButtonLink, Text } from '@holdfast-io/ui/components'
...
const MetadataPanel = () => {
	...
	const sessionData: TableListItem[] = [
		{
			...
			valueInfoTooltipMessage: (
				<>
					...
					recorded.{' '}
					<a
						href="/docs/api#w0-highlightoptions"
						target="_blank"
		...
		},
		{
			...
			valueInfoTooltipMessage: (
				<>
					...
					<a
						href="/docs/getting-started/browser/replay-configuration/privacy"
						target="_blank"
						rel="noreferrer"
					>
		...
		},
		{
			...
			valueInfoTooltipMessage: (
				<>
					This specifies whether HoldFast records the status codes,
					headers, and bodies for XML/Fetch requests made in your app.{' '}
					<a
						href="/docs/getting-started/browser/replay-configuration/recording-network-requests-and-responses"
						target="_blank"
						rel="noopener noreferrer"
					>
	...
	const userData: TableListItem[] = [
		{
			...
			valueInfoTooltipMessage: !session?.identifier && (
				<>
					...
					<a
						href="/docs/getting-started/browser/replay-configuration/identifying-sessions"
						target="_blank"
						rel="noreferrer"
					>
						learn more here
	...
	const environmentData: TableListItem[] = browserExtensionScriptURLs.map(
		(scriptUrl) => ({
			...
			valueInfoTooltipMessage:
				"HoldFast detected a browser extension is installed and might interfere with your app's behavior.",
		}),
	)
	if (!session) {
		return (
