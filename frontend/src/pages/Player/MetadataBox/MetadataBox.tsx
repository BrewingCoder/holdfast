...
export const MetadataBox = React.memo(() => {
	...
	const userData = useMemo(() => {
		...
		const enhancedUserDataTooltipMessage =
			...
			`HoldFast shows additional information like social handles, website, title, and company.`
				...
				>
					...
					{backfilled && (
						<Box
							...
							onClick={() => {
								window.open(
									'/docs/getting-started/browser/replay-configuration/identifying-sessions#what-happens-before-a-user-is-identified',
									'_blank',
								)
							}}
						>
