import { Heading, Stack } from '@holdfast-io/ui/components'
...
const dbcache = {
	...
	info: 'IndexedDB Browser Cache is used to preload all data in HoldFast and speed up repeated loading, but it can increase memory usage.',
}
