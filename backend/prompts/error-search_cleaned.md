In HoldFast, you can search for a errors using different attributes on the error group and error
...
| `visited_url`       | URL where the error occurred                       | `https://app.holdfast.io/1/errors`                                                                                                                  |
